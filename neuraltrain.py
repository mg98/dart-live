...
from fpdgd.ranker.PDGDNeuralRanker import PDGDNeuralRanker
...
def train_local_pdgd(ranker: PDGDNeuralRanker,
    ...
    Args:
        ranker: PDGDNeuralRanker instance
...
def evaluate(ranker: PDGDNeuralRanker,
    ...
    Args:
        ranker: Trained PDGDNeuralRanker
...
def main():
    ...
    model_path = os.path.join(model_dir, "pdgd_neural_ranker.npy")
    np.save(model_path, ranker.get_current_weights(), allow_pickle=True)
